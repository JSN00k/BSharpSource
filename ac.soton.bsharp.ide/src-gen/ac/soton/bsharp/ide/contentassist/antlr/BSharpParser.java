...
public class BSharpParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BSharpGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTypeInstanceAccess().getGroup_1(), "rule__TypeInstance__Group_1__0");
			builder.put(grammarAccess.getTypeInstanceAccess().getGroup_1_1(), "rule__TypeInstance__Group_1_1__0");
			...
			builder.put(grammarAccess.getDatatypeAccess().getTypeNameAssignment_1(), "rule__Datatype__TypeNameAssignment_1");
			builder.put(grammarAccess.getDatatypeAccess().getContextAssignment_2(), "rule__Datatype__ContextAssignment_2");
			builder.put(grammarAccess.getDatatypeAccess().getVarListAssignment_3_1(), "rule__Datatype__VarListAssignment_3_1");
			...
			builder.put(grammarAccess.getTheoremDeclAccess().getThmNameAssignment_0(), "rule__TheoremDecl__ThmNameAssignment_0");
			...
			builder.put(grammarAccess.getLambdaAccess().getChildAssignment_4(), "rule__Lambda__ChildAssignment_4");
			...
			builder.put(grammarAccess.getQuantifierAccess().getChildAssignment_4(), "rule__Quantifier__ChildAssignment_4");
			...
			builder.put(grammarAccess.getTypeInstanceAccess().getInstanceAssignment_0(), "rule__TypeInstance__InstanceAssignment_0");
			builder.put(grammarAccess.getTypeInstanceAccess().getTypeNameAssignment_1_0(), "rule__TypeInstance__TypeNameAssignment_1_0");
			builder.put(grammarAccess.getTypeInstanceAccess().getElementAssignment_1_1_1(), "rule__TypeInstance__ElementAssignment_1_1_1");
