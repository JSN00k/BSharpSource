...
public class BSharpParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BSharpGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getIfElseAccess().getIfTrueExprAssignment_3(), "rule__IfElse__IfTrueExprAssignment_3");
			builder.put(grammarAccess.getIfElseAccess().getIfFalseExprAssignment_7(), "rule__IfElse__IfFalseExprAssignment_7");
