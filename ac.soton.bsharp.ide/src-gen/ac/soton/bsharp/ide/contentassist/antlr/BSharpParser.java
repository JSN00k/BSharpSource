		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMatchStatementAccess().getGroup(), "rule__MatchStatement__Group__0");
					put(grammarAccess.getMatchCaseAccess().getGroup(), "rule__MatchCase__Group__0");
					put(grammarAccess.getMatchCaseAccess().getGroup_2(), "rule__MatchCase__Group_2__0");
					put(grammarAccess.getMatchCaseAccess().getGroup_2_2(), "rule__MatchCase__Group_2_2__0");
					...
					put(grammarAccess.getFunctionDeclAccess().getExprAssignment_9(), "rule__FunctionDecl__ExprAssignment_9");
					put(grammarAccess.getFunctionNameAccess().getNameAssignment(), "rule__FunctionName__NameAssignment");
					put(grammarAccess.getMatchStatementAccess().getMatchAssignment_1(), "rule__MatchStatement__MatchAssignment_1");
					put(grammarAccess.getMatchStatementAccess().getInductCaseAssignment_3(), "rule__MatchStatement__InductCaseAssignment_3");
					put(grammarAccess.getMatchStatementAccess().getInductCaseAssignment_4(), "rule__MatchStatement__InductCaseAssignment_4");
					put(grammarAccess.getMatchCaseAccess().getDeconNameAssignment_1(), "rule__MatchCase__DeconNameAssignment_1");
					put(grammarAccess.getMatchCaseAccess().getVariablesAssignment_2_1(), "rule__MatchCase__VariablesAssignment_2_1");
					put(grammarAccess.getMatchCaseAccess().getVariablesAssignment_2_2_1(), "rule__MatchCase__VariablesAssignment_2_2_1");
					put(grammarAccess.getMatchCaseAccess().getExprAssignment_4(), "rule__MatchCase__ExprAssignment_4");
