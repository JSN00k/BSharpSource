...
import ac.soton.bsharp.ui.contentassist.RodinPrefixMatcher;

/**
 * <p>
 * Rodin symbol proposal provider, allowing to type Rodin symbols via content
 * assist. This file is borrowed from the XEventB project, to avoiding having
 * to add all of the dependencies of XEventB to allow dependencies. 
 * </p>
 *
 * @author htson
 * @version 0.1
