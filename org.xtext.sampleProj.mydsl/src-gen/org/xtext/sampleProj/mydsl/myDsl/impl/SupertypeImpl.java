...
public class SupertypeImpl extends MinimalEObjectImpl.Container implements Supertype
{
   ...
   * @ordered
   */
  protected EList<TypeDeclaration> superType;
   ...
   * @generated
   */
  public EList<TypeDeclaration> getSuperType()
  {
    if (superType == null)
    {
      superType = new EObjectContainmentEList<TypeDeclaration>(TypeDeclaration.class, this, MyDslPackage.SUPERTYPE__SUPER_TYPE);
    }
    return superType;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MyDslPackage.SUPERTYPE__SUPER_TYPE:
        getSuperType().clear();
        getSuperType().addAll((Collection<? extends TypeDeclaration>)newValue);
        return;
    }
