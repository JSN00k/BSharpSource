 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.sampleProj.mydsl.myDsl.impl.PolyContextImpl#getPolyTypes <em>Poly Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolyContextImpl extends MinimalEObjectImpl.Container implements PolyContext
{
  ...
  {
    return MyDslPackage.Literals.POLY_CONTEXT;
  }
  ...
  public EList<PolyContextTypes> getPolyTypes()
  {
    if (polyTypes == null)
    {
      polyTypes = new EObjectContainmentEList<PolyContextTypes>(PolyContextTypes.class, this, MyDslPackage.POLY_CONTEXT__POLY_TYPES);
    }
    return polyTypes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.POLY_CONTEXT__POLY_TYPES:
