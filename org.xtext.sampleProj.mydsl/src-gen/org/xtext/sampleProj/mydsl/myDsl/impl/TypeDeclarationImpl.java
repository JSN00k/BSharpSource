 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.sampleProj.mydsl.myDsl.impl.TypeDeclarationImpl#getTypeName <em>Type Name</em>}</li>
 *   <li>{@link org.xtext.sampleProj.mydsl.myDsl.impl.TypeDeclarationImpl#getContext <em>Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeDeclarationImpl extends MinimalEObjectImpl.Container implements TypeDeclaration
{
    ...
    if (typeName != null && typeName.eIsProxy())
    {
      ...
      if (typeName != oldTypeName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.TYPE_DECLARATION__TYPE_NAME, oldTypeName, typeName));
      }
    }
    return typeName;
  }
  ...
  public void setTypeName(TypeName newTypeName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TYPE_DECLARATION__TYPE_NAME, oldTypeName, typeName));
  }
  ...
  public NotificationChain basicSetContext(TypeDeclContext newContext, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.TYPE_DECLARATION__CONTEXT, oldContext, newContext);
  ...
  public void setContext(TypeDeclContext newContext)
  {
    if (newContext != context)
    {
      ...
      if (context != null)
        msgs = ((InternalEObject)context).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TYPE_DECLARATION__CONTEXT, null, msgs);
      if (newContext != null)
        msgs = ((InternalEObject)newContext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.TYPE_DECLARATION__CONTEXT, null, msgs);
      msgs = basicSetContext(newContext, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.TYPE_DECLARATION__CONTEXT, newContext, newContext));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.TYPE_DECLARATION__CONTEXT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.TYPE_DECLARATION__TYPE_NAME:
