...
public interface TypedVariable extends EObject
{
   ...
   * @see #setName(String)
   * @see org.xtext.sampleProj.mydsl.myDsl.MyDslPackage#getTypedVariable_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.sampleProj.mydsl.myDsl.TypedVariable#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
