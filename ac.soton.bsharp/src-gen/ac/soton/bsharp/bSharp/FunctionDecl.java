 ...
 *   <li>{@link ac.soton.bsharp.bSharp.FunctionDecl#getBody <em>Body</em>}</li>
 * </ul>
 *
...
public interface FunctionDecl extends EObject
{
   ...
   * The list contents are of type {@link ac.soton.bsharp.bSharp.FunctionName}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see ac.soton.bsharp.bSharp.BSharpPackage#getFunctionDecl_Body()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link ac.soton.bsharp.bSharp.FunctionDecl#getBody <em>Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
