...
public interface BSharpPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_INSTANCE__NAME = NAMED_OBJECT__NAME;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_INSTANCE__BLOCK = NAMED_OBJECT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_INSTANCE_FEATURE_COUNT = NAMED_OBJECT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CLASS_DECL__NAME = TOP_LEVEL_INSTANCE__NAME;
	 ...
	 * @ordered
	 */
	int CLASS_DECL_FEATURE_COUNT = TOP_LEVEL_INSTANCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int CLASS_VAR_DECL__TYPE_VAR = IVAR_TYPE_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>Typed Var</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int CLASS_VAR_DECL__TYPED_VAR = IVAR_TYPE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int CLASS_VAR_DECL_FEATURE_COUNT = IVAR_TYPE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TYPE_BUILDER__NAME = EXPRESSION_VARIABLE__NAME;
	 ...
	 * @ordered
	 */
	int TYPE_BUILDER_FEATURE_COUNT = EXPRESSION_VARIABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int CONSTRUCTED_TYPE__NAME = TYPE_BUILDER__NAME;
	 ...
	 * @ordered
	 */
	int EXTEND__NAME = TOP_LEVEL_INSTANCE__NAME;
	 ...
	 * @ordered
	 */
	int EXTEND__BLOCK = TOP_LEVEL_INSTANCE__BLOCK;
	 ...
	 * @ordered
	 */
	int EXTEND__EXTENDED_CLASS = TOP_LEVEL_INSTANCE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int EXTEND__EXTENDED_CLASS_NAME = TOP_LEVEL_INSTANCE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int EXTEND_FEATURE_COUNT = TOP_LEVEL_INSTANCE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int FILE_IMPORT__FILE_REFERENCE = 1;
	 ...
	 * @ordered
	 */
	int FILE_IMPORT_FEATURE_COUNT = 4;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL__CONTEXT = EXPRESSION_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL__WRAPPED = EXPRESSION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL__COMPILATION_OBJECT = EXPRESSION_FEATURE_COUNT + 2;

	/**
	 * The feature id for the '<em><b>Func Call Args</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FUNCTION_CALL__FUNC_CALL_ARGS = EXPRESSION_FEATURE_COUNT + 3;

	/**
	 * The feature id for the '<em><b>Gen Inbuilt Func</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FUNCTION_CALL__GEN_INBUILT_FUNC = EXPRESSION_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL__GETTER = EXPRESSION_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL__CLASS_VAR_DECL = EXPRESSION_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_FEATURE_COUNT = EXPRESSION_FEATURE_COUNT + 7;

	/**
	 * The meta object id for the '{@link ac.soton.bsharp.bSharp.impl.FunctionCallInbuiltImpl <em>Function Call Inbuilt</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ac.soton.bsharp.bSharp.impl.FunctionCallInbuiltImpl
	 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getFunctionCallInbuilt()
	 * @generated
	 */
	int FUNCTION_CALL_INBUILT = 24;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__TYPE_INST = FUNCTION_CALL__TYPE_INST;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__CONTEXT = FUNCTION_CALL__CONTEXT;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__WRAPPED = FUNCTION_CALL__WRAPPED;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__COMPILATION_OBJECT = FUNCTION_CALL__COMPILATION_OBJECT;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__FUNC_CALL_ARGS = FUNCTION_CALL__FUNC_CALL_ARGS;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__GEN_INBUILT_FUNC = FUNCTION_CALL__GEN_INBUILT_FUNC;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__GETTER = FUNCTION_CALL__GETTER;
	 ...
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__CLASS_VAR_DECL = FUNCTION_CALL__CLASS_VAR_DECL;

	/**
	 * The feature id for the '<em><b>Inbuilt Unary</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT__INBUILT_UNARY = FUNCTION_CALL_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Function Call Inbuilt</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FUNCTION_CALL_INBUILT_FEATURE_COUNT = FUNCTION_CALL_FEATURE_COUNT + 1;

	/**
	 * The meta object id for the '{@link ac.soton.bsharp.bSharp.impl.FuncCallArgsImpl <em>Func Call Args</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ac.soton.bsharp.bSharp.impl.FuncCallArgsImpl
	 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getFuncCallArgs()
	 * @generated
	 */
	int FUNC_CALL_ARGS = 25;
	 ...
	 * @ordered
	 */
	int FUNC_CALL_ARGS__ARGUMENTS = 0;

	/**
	 * The number of structural features of the '<em>Func Call Args</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int FUNC_CALL_ARGS_FEATURE_COUNT = 1;
	 ...
	 * @ordered
	 */
	int GEN_NAME__NAME = EXPRESSION_VARIABLE__NAME;
	 ...
	 * @ordered
	 */
	int GEN_NAME_FEATURE_COUNT = EXPRESSION_VARIABLE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GLOBAL_IMPORT__FILE_IMPORTS = IMPORT__FILE_IMPORTS;
	 ...
	 * @ordered
	 */
	int GLOBAL_IMPORT__PROJECT = IMPORT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GLOBAL_IMPORT_FEATURE_COUNT = IMPORT_FEATURE_COUNT + 1;

	/**
	 * The meta object id for the '{@link ac.soton.bsharp.bSharp.impl.IfElseImpl <em>If Else</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ac.soton.bsharp.bSharp.impl.IfElseImpl
	 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getIfElse()
	 * @generated
	 */
	int IF_ELSE = 29;
	 ...
	 * @ordered
	 */
	int IF_ELSE__TYPE_INST = EXPRESSION__TYPE_INST;
	...
	/**
	 * The feature id for the '<em><b>If True Expr</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int IF_ELSE__IF_TRUE_EXPR = EXPRESSION_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>If False Expr</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int IF_ELSE__IF_FALSE_EXPR = EXPRESSION_FEATURE_COUNT + 2;
	...
	/**
	 * The meta object id for the '{@link ac.soton.bsharp.bSharp.impl.InbuiltPrefixFuncNameImpl <em>Inbuilt Prefix Func Name</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ac.soton.bsharp.bSharp.impl.InbuiltPrefixFuncNameImpl
	 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getInbuiltPrefixFuncName()
	 * @generated
	 */
	int INBUILT_PREFIX_FUNC_NAME = 31;
	 ...
	 * @ordered
	 */
	int INBUILT_PREFIX_FUNC_NAME__NAME = EXPRESSION_VARIABLE__NAME;

	/**
	 * The number of structural features of the '<em>Inbuilt Prefix Func Name</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INBUILT_PREFIX_FUNC_NAME_FEATURE_COUNT = EXPRESSION_VARIABLE_FEATURE_COUNT + 0;
	...
	/**
	 * The feature id for the '<em><b>Referencing Funcs</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INSTANCE__REFERENCING_FUNCS = IEXPRESSION_CONTAINER_FEATURE_COUNT + 5;
	 ...
	 * @ordered
	 */
	int INSTANCE_FEATURE_COUNT = IEXPRESSION_CONTAINER_FEATURE_COUNT + 6;
	 ...
	 * @ordered
	 */
	int LOCAL_IMPORT__FILE_IMPORTS = IMPORT__FILE_IMPORTS;
	 ...
	 * @ordered
	 */
	int LOCAL_IMPORT_FEATURE_COUNT = IMPORT_FEATURE_COUNT + 0;
	...
	/**
	 * The meta object id for the '{@link ac.soton.bsharp.bSharp.impl.ReferencingFuncImpl <em>Referencing Func</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ac.soton.bsharp.bSharp.impl.ReferencingFuncImpl
	 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getReferencingFunc()
	 * @generated
	 */
	int REFERENCING_FUNC = 44;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__NAME = FUNCTION_DECL__NAME;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__PRECEDENCE = FUNCTION_DECL__PRECEDENCE;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__CONTEXT = FUNCTION_DECL__CONTEXT;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__VAR_LIST = FUNCTION_DECL__VAR_LIST;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__RETURN_TYPE = FUNCTION_DECL__RETURN_TYPE;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__INFIX = FUNCTION_DECL__INFIX;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__EXPR = FUNCTION_DECL__EXPR;
	 ...
	 * @ordered
	 */
	int REFERENCING_FUNC__REFERENCED_FUNC = FUNCTION_DECL_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Referencing Func</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int REFERENCING_FUNC_FEATURE_COUNT = FUNCTION_DECL_FEATURE_COUNT + 1;
	...
	/**
	 * The feature id for the '<em><b>Generated Quants</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int THEOREM_DECL__GENERATED_QUANTS = IEXPRESSION_CONTAINER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int THEOREM_DECL_FEATURE_COUNT = IEXPRESSION_CONTAINER_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_IMPORT__IMPORTS = ITHEORY_IMPORT_CACHE_PROVIDER_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_IMPORT__BODY_ELEMENTS = ITHEORY_IMPORT_CACHE_PROVIDER_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_IMPORT__IMPORT_REFS = ITHEORY_IMPORT_CACHE_PROVIDER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int TOP_LEVEL_IMPORT_FEATURE_COUNT = ITHEORY_IMPORT_CACHE_PROVIDER_FEATURE_COUNT + 3;

	/**
	 * The meta object id for the '{@link ac.soton.bsharp.bSharp.impl.TupleImpl <em>Tuple</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see ac.soton.bsharp.bSharp.impl.TupleImpl
	 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getTuple()
	 * @generated
	 */
	int TUPLE = 51;
	 ...
	 * @ordered
	 */
	int TUPLE__TYPE_INST = EXPRESSION__TYPE_INST;
	 ...
	 * @ordered
	 */
	int TYPE_CONSTRUCTOR__NAME = TYPE_BUILDER__NAME;
	 ...
	 * @ordered
	 */
	int TYPE_CONSTR_BRACKET__NAME = TYPE_BUILDER__NAME;
	 ...
	 * @ordered
	 */
	int TYPE_POWER_SET__NAME = TYPE_BUILDER__NAME;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ac.soton.bsharp.bSharp.TopLevelImport#getImports <em>Imports</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Imports</em>'.
	 * @see ac.soton.bsharp.bSharp.TopLevelImport#getImports()
	 * @see #getTopLevelImport()
	 * @generated
	 */
	EReference getTopLevelImport_Imports();
	...
	/**
	 * Returns the meta object for class '{@link ac.soton.bsharp.bSharp.Tuple <em>Tuple</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ac.soton.bsharp.bSharp.Tuple#getElements <em>Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Elements</em>'.
	 * @see ac.soton.bsharp.bSharp.Tuple#getElements()
	 * @see #getTuple()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ac.soton.bsharp.bSharp.TheoremDecl#getGeneratedQuants <em>Generated Quants</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Generated Quants</em>'.
	 * @see ac.soton.bsharp.bSharp.TheoremDecl#getGeneratedQuants()
	 * @see #getTheoremDecl()
	 * @generated
	 */
	EReference getTheoremDecl_GeneratedQuants();
	...
	/**
	 * Returns the meta object for class '{@link ac.soton.bsharp.bSharp.ReferencingFunc <em>Referencing Func</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Referencing Func</em>'.
	 * @see ac.soton.bsharp.bSharp.ReferencingFunc
	 * @generated
	 */
	EClass getReferencingFunc();

	/**
	 * Returns the meta object for the reference '{@link ac.soton.bsharp.bSharp.ReferencingFunc#getReferencedFunc <em>Referenced Func</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Referenced Func</em>'.
	 * @see ac.soton.bsharp.bSharp.ReferencingFunc#getReferencedFunc()
	 * @see #getReferencingFunc()
	 * @generated
	 */
	EReference getReferencingFunc_ReferencedFunc();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ac.soton.bsharp.bSharp.FunctionCall#getFuncCallArgs <em>Func Call Args</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Func Call Args</em>'.
	 * @see ac.soton.bsharp.bSharp.FunctionCall#getFuncCallArgs()
	 * @see #getFunctionCall()
	 * @generated
	 */
	EReference getFunctionCall_FuncCallArgs();

	/**
	 * Returns the meta object for the containment reference '{@link ac.soton.bsharp.bSharp.FunctionCall#getGenInbuiltFunc <em>Gen Inbuilt Func</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Gen Inbuilt Func</em>'.
	 * @see ac.soton.bsharp.bSharp.FunctionCall#getGenInbuiltFunc()
	 * @see #getFunctionCall()
	 * @generated
	 */
	EReference getFunctionCall_GenInbuiltFunc();

	/**
	 * Returns the meta object for the reference '{@link ac.soton.bsharp.bSharp.FunctionCall#getGetter <em>Getter</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Getter</em>'.
	 * @see ac.soton.bsharp.bSharp.FunctionCall#getGetter()
	 * @see #getFunctionCall()
	 * @generated
	 */
	EReference getFunctionCall_Getter();
	...
	/**
	 * Returns the meta object for class '{@link ac.soton.bsharp.bSharp.FunctionCallInbuilt <em>Function Call Inbuilt</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Function Call Inbuilt</em>'.
	 * @see ac.soton.bsharp.bSharp.FunctionCallInbuilt
	 * @generated
	 */
	EClass getFunctionCallInbuilt();

	/**
	 * Returns the meta object for the attribute '{@link ac.soton.bsharp.bSharp.FunctionCallInbuilt#getInbuiltUnary <em>Inbuilt Unary</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Inbuilt Unary</em>'.
	 * @see ac.soton.bsharp.bSharp.FunctionCallInbuilt#getInbuiltUnary()
	 * @see #getFunctionCallInbuilt()
	 * @generated
	 */
	EAttribute getFunctionCallInbuilt_InbuiltUnary();

	/**
	 * Returns the meta object for class '{@link ac.soton.bsharp.bSharp.FuncCallArgs <em>Func Call Args</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Func Call Args</em>'.
	 * @see ac.soton.bsharp.bSharp.FuncCallArgs
	 * @generated
	 */
	EClass getFuncCallArgs();

	/**
	 * Returns the meta object for the containment reference list '{@link ac.soton.bsharp.bSharp.FuncCallArgs#getArguments <em>Arguments</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Arguments</em>'.
	 * @see ac.soton.bsharp.bSharp.FuncCallArgs#getArguments()
	 * @see #getFuncCallArgs()
	 * @generated
	 */
	EReference getFuncCallArgs_Arguments();
	...
	/**
	 * Returns the meta object for the reference '{@link ac.soton.bsharp.bSharp.ClassVarDecl#getTypeVar <em>Type Var</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Type Var</em>'.
	 * @see ac.soton.bsharp.bSharp.ClassVarDecl#getTypeVar()
	 * @see #getClassVarDecl()
	 * @generated
	 */
	EReference getClassVarDecl_TypeVar();

	/**
	 * Returns the meta object for the reference '{@link ac.soton.bsharp.bSharp.ClassVarDecl#getTypedVar <em>Typed Var</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Typed Var</em>'.
	 * @see ac.soton.bsharp.bSharp.ClassVarDecl#getTypedVar()
	 * @see #getClassVarDecl()
	 * @generated
	 */
	EReference getClassVarDecl_TypedVar();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ac.soton.bsharp.bSharp.Instance#getReferencingFuncs <em>Referencing Funcs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Referencing Funcs</em>'.
	 * @see ac.soton.bsharp.bSharp.Instance#getReferencingFuncs()
	 * @see #getInstance()
	 * @generated
	 */
	EReference getInstance_ReferencingFuncs();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link ac.soton.bsharp.bSharp.Import#getFileImports <em>File Imports</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>File Imports</em>'.
	 * @see ac.soton.bsharp.bSharp.Import#getFileImports()
	 * @see #getImport()
	 * @generated
	 */
	EReference getImport_FileImports();
	...
	/**
	 * Returns the meta object for class '{@link ac.soton.bsharp.bSharp.IfElse <em>If Else</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link ac.soton.bsharp.bSharp.IfElse#getCondition <em>Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Condition</em>'.
	 * @see ac.soton.bsharp.bSharp.IfElse#getCondition()
	 * @see #getIfElse()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link ac.soton.bsharp.bSharp.IfElse#getIfTrueExpr <em>If True Expr</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>If True Expr</em>'.
	 * @see ac.soton.bsharp.bSharp.IfElse#getIfTrueExpr()
	 * @see #getIfElse()
	 * @generated
	 */
	EReference getIfElse_IfTrueExpr();

	/**
	 * Returns the meta object for the containment reference '{@link ac.soton.bsharp.bSharp.IfElse#getIfFalseExpr <em>If False Expr</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>If False Expr</em>'.
	 * @see ac.soton.bsharp.bSharp.IfElse#getIfFalseExpr()
	 * @see #getIfElse()
	 * @generated
	 */
	EReference getIfElse_IfFalseExpr();
	...
	/**
	 * Returns the meta object for class '{@link ac.soton.bsharp.bSharp.InbuiltPrefixFuncName <em>Inbuilt Prefix Func Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Inbuilt Prefix Func Name</em>'.
	 * @see ac.soton.bsharp.bSharp.InbuiltPrefixFuncName
	 * @generated
	 */
	EClass getInbuiltPrefixFuncName();
	...
	/**
	 * Returns the meta object for the attribute '{@link ac.soton.bsharp.bSharp.FileImport#getTypeName <em>Type Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Type Name</em>'.
	 * @see ac.soton.bsharp.bSharp.FileImport#getTypeName()
	 * @see #getFileImport()
	 * @generated
	 */
	EAttribute getFileImport_TypeName();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference TOP_LEVEL_IMPORT__IMPORTS = eINSTANCE.getTopLevelImport_Imports();
		...
		/**
		 * The meta object literal for the '{@link ac.soton.bsharp.bSharp.impl.TupleImpl <em>Tuple</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ac.soton.bsharp.bSharp.impl.TupleImpl
		 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getTuple()
		...
		/**
		 * The meta object literal for the '<em><b>Generated Quants</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference THEOREM_DECL__GENERATED_QUANTS = eINSTANCE.getTheoremDecl_GeneratedQuants();
		...
		/**
		 * The meta object literal for the '{@link ac.soton.bsharp.bSharp.impl.ReferencingFuncImpl <em>Referencing Func</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ac.soton.bsharp.bSharp.impl.ReferencingFuncImpl
		 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getReferencingFunc()
		 * @generated
		 */
		EClass REFERENCING_FUNC = eINSTANCE.getReferencingFunc();

		/**
		 * The meta object literal for the '<em><b>Referenced Func</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference REFERENCING_FUNC__REFERENCED_FUNC = eINSTANCE.getReferencingFunc_ReferencedFunc();
		...
		/**
		 * The meta object literal for the '<em><b>Func Call Args</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference FUNCTION_CALL__FUNC_CALL_ARGS = eINSTANCE.getFunctionCall_FuncCallArgs();

		/**
		 * The meta object literal for the '<em><b>Gen Inbuilt Func</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference FUNCTION_CALL__GEN_INBUILT_FUNC = eINSTANCE.getFunctionCall_GenInbuiltFunc();
		 ...
		 * @generated
		 */
		EReference FUNCTION_CALL__GETTER = eINSTANCE.getFunctionCall_Getter();
		...
		/**
		 * The meta object literal for the '{@link ac.soton.bsharp.bSharp.impl.FunctionCallInbuiltImpl <em>Function Call Inbuilt</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ac.soton.bsharp.bSharp.impl.FunctionCallInbuiltImpl
		 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getFunctionCallInbuilt()
		 * @generated
		 */
		EClass FUNCTION_CALL_INBUILT = eINSTANCE.getFunctionCallInbuilt();

		/**
		 * The meta object literal for the '<em><b>Inbuilt Unary</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute FUNCTION_CALL_INBUILT__INBUILT_UNARY = eINSTANCE.getFunctionCallInbuilt_InbuiltUnary();

		/**
		 * The meta object literal for the '{@link ac.soton.bsharp.bSharp.impl.FuncCallArgsImpl <em>Func Call Args</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ac.soton.bsharp.bSharp.impl.FuncCallArgsImpl
		 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getFuncCallArgs()
		 * @generated
		 */
		EClass FUNC_CALL_ARGS = eINSTANCE.getFuncCallArgs();
		 ...
		 * @generated
		 */
		EReference FUNC_CALL_ARGS__ARGUMENTS = eINSTANCE.getFuncCallArgs_Arguments();
		 ...
		 * @generated
		 */
		EReference CLASS_VAR_DECL__TYPE_VAR = eINSTANCE.getClassVarDecl_TypeVar();

		/**
		 * The meta object literal for the '<em><b>Typed Var</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference CLASS_VAR_DECL__TYPED_VAR = eINSTANCE.getClassVarDecl_TypedVar();
		...
		/**
		 * The meta object literal for the '<em><b>Referencing Funcs</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference INSTANCE__REFERENCING_FUNCS = eINSTANCE.getInstance_ReferencingFuncs();
		 ...
		 * @generated
		 */
		EReference IMPORT__FILE_IMPORTS = eINSTANCE.getImport_FileImports();
		...
		/**
		 * The meta object literal for the '{@link ac.soton.bsharp.bSharp.impl.IfElseImpl <em>If Else</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ac.soton.bsharp.bSharp.impl.IfElseImpl
		 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getIfElse()
		...
		/**
		 * The meta object literal for the '<em><b>If True Expr</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference IF_ELSE__IF_TRUE_EXPR = eINSTANCE.getIfElse_IfTrueExpr();

		/**
		 * The meta object literal for the '<em><b>If False Expr</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference IF_ELSE__IF_FALSE_EXPR = eINSTANCE.getIfElse_IfFalseExpr();
		...
		/**
		 * The meta object literal for the '{@link ac.soton.bsharp.bSharp.impl.InbuiltPrefixFuncNameImpl <em>Inbuilt Prefix Func Name</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see ac.soton.bsharp.bSharp.impl.InbuiltPrefixFuncNameImpl
		 * @see ac.soton.bsharp.bSharp.impl.BSharpPackageImpl#getInbuiltPrefixFuncName()
		 * @generated
		 */
		EClass INBUILT_PREFIX_FUNC_NAME = eINSTANCE.getInbuiltPrefixFuncName();
		 ...
		 * @generated
		 */
		EAttribute FILE_IMPORT__TYPE_NAME = eINSTANCE.getFileImport_TypeName();
