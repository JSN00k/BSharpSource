 ...
 * </p>
 * <ul>
 *   <li>{@link ac.soton.bsharp.bSharp.impl.TypedVariableImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypedVariableImpl extends ExpressionVariableImpl implements TypedVariable {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BSharpPackage.TYPED_VARIABLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BSharpPackage.TYPED_VARIABLE__NAME:
				return getName();
		}
